...
axis.Date(1, at=ejex.año, labels = FALSE, tcl = -0.1)
...
win.graph()
par(mfrow=c(1,1))
plot(tf,yrf,type = 'o',main="Pronóstico", xlim = c(193, 204), ylim = c(200,400))
...
win.graph()
par(mfrow=c(1,1))
plot(tf,yrf, type = 'b', main="Pronóstico Obs vs STL y HWA", ylim = c(200,400), 
